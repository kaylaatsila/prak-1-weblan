...
<head>
    ...
    <link rel="stylesheet" href="/assets/AdminLTE/plugins/summernote/summernote-bs5.min.css">
...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; Kayla, 2022</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <script src="/assets/AdminLTE/plugins/summernote/summernote-bs5.min.js"></script>
